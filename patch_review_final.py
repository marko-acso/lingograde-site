...
<p style="margin:0 0 8px;font-size:1rem;font-weight:600;color:#1C1C1C;">Know someone who needs a language assessment?</p>
<p style="margin:0 0 16px;font-size:0.9rem;color:var(--ink-soft);">Share LingoGrade with them.</p>
<div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap;">
<a href="https://wa.me/?text=I%20just%20got%20my%20CEFR%20level%20assessed%20at%20LingoGrade.%20Professional%20and%20fast.%20Check%20it%20out%3A%20https%3A%2F%2Fwww.lingograde.com%3Fref%3Dreview" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:6px;padding:10px 20px;background:#25D366;color:white;border-radius:8px;text-decoration:none;font-weight:600;font-size:0.9rem;"><svg width="18" height="18" viewBox="0 0 24 24" fill="white"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M12 2C6.477 2 2 6.477 2 12c0 1.89.525 3.66 1.438 5.168L2 22l4.832-1.438A9.96 9.96 0 0012 22c5.523 0 10-4.477 10-10S17.523 2 12 2zm0 18a8 8 0 01-4.105-1.127l-.29-.174-3.01.789.803-2.927-.191-.303A7.96 7.96 0 014 12a8 8 0 1116 0 8 8 0 01-8 8z"/></svg>WhatsApp</a>
<a href="mailto:?subject=LingoGrade%20%E2%80%93%20Professional%20CEFR%20Assessment&body=I%20just%20got%20my%20CEFR%20level%20assessed%20at%20LingoGrade.%20Professional%20and%20fast.%20Check%20it%20out%3A%20https%3A%2F%2Fwww.lingograde.com%3Fref%3Dreview" style="display:inline-flex;align-items:center;gap:6px;padding:10px 20px;background:var(--accent);color:white;border-radius:8px;text-decoration:none;font-weight:600;font-size:0.9rem;"><svg width="18" height="18" viewBox="0 0 24 24" fill="white"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>Email</a>
<button onclick="copyLink()" style="display:inline-flex;align-items:center;gap:6px;padding:10px 20px;background:#6c757d;color:white;border-radius:8px;border:none;cursor:pointer;font-weight:600;font-size:0.9rem;font-family:inherit;" id="copyBtn"><svg width="18" height="18" viewBox="0 0 24 24" fill="white"><path d="M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"/></svg>Copy Link</button>
</div>
</div>
...
function selectOpt(el,group){el.parentElement.querySelectorAll('.opt').forEach(function(o){o.classList.remove('selected');});el.classList.add('selected');data[group]=el.textContent.trim();var btnId=group==='valuable'?'btn2':'btn3';document.getElementById(btnId).disabled=false;}
function goTo(step){document.querySelectorAll('.step').forEach(function(s){s.classList.remove('active');});document.getElementById('step'+step).classList.add('active');var dots=document.querySelectorAll('.dot');dots.forEach(function(d,i){d.className='dot';if(i<step-1)d.classList.add('done');if(i===step-1)d.classList.add('current');});}
